<x-layout>
    <main class="flex flex-col gap-1 text-white font-[chinese] text-[20px]">
        <a href="{{ route('download.menu') }}" class="bg-[url(/public/images/menu_bg_gradient.png)] border-r-1 border-b-1 border-white hover:cursor-pointer h-7 w-fit px-3 text-center self-end">
            Download Menu
        </a>
