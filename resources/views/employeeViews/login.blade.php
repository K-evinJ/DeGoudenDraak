<x-employeeLayout>
    <div>
        <form class="flex flex-col place-items-center justify-self-center w-75 border border-gray-400 rounded-2xl py-6 mt-30 text-sm" method="POST">
    ...
    @if (session('login_error') != null)
        <div class='text-red-500 font-bold text-center p-[10]'>{{ session('login_error') }}</div>
    @endif
</x-employeeLayout>